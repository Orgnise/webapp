...
export default class WorkspaceService {
     ...
     * @returns {Promise<AxiosResponse<any>>}
     */
    async getWorkspaceById(orgId: string, id: string): Promise<AxiosResponse<any>> {
        return this.client
     ...
     * @returns {Promise<AxiosResponse<any>>}
     */
    async createWorkspace(orgId: string, payload: any): Promise<AxiosResponse<any>> {
        return this.client
     ...
     * @returns {Promise<AxiosResponse<any>>}
     */
    async addExampleWorkspaces(orgId: string, payload: any): Promise<AxiosResponse<any>> {
        return this.client
     ...
     * @returns {Promise<AxiosResponse<any>>}
     */
    async addExampleWorkspaceBySlug(slug: string, payload: any): Promise<AxiosResponse<any>> {
        return this.client
